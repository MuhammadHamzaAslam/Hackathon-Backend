...
import LoanModal from "../models/loanModal.js";
import AppointmentModal from "../models/appointmentModal.js";
import { calculateLoanBreakdown, convertPasswordToHash, generateRandomPassword, generateTokenSlip, sendResetPasswordEmail } from "../lib/helperFunction.js";
const loanRouter = express.Router();

loanRouter.post("/submitLoan", async (req, res) => {
  try {
    const {
      category,
      subcategory,
...
loanRouter.post("/reviewForm", async (req, res) => {
  try {
